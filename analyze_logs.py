...
# This functions reads and extractd data from the 'attack.log' file.If the file is not found then it stops the script and gives an error message.
def parsingLogFile(logFile='logs/attacks.log'):
    ...
    for line in logs:
        ...
        #MIf all data found, then makes a small dictonary similar to a mini database entry
